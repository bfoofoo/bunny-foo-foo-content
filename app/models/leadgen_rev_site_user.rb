class LeadgenRevSiteUser < ApplicationRecord
  ...
  delegate :email, :first_name, :last_name, :sent_to_adopia?, :sent_to_elite?,
           :sent_to_netatlantic?, :full_name, :sent_to_mailgun?, :sent_to_onepoint?, :sent_to_sparkpost?, :sent_to_getresponse?, :sent_to_allinbox?, :sent_to_constantcontact?, :sent_to_mailigen? ,
